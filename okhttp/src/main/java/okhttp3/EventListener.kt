 ...
 *
 * HTTP请求的监控类，通过继承这个Listener可以兼容请求的大小、时间等内容。
 *
 * 不管成功还是失败，所有的start/connect/acquire事件都会有对应的end/release事件。
 *
...
abstract class EventListener {
    ...
    interface Factory {
        /**
         *
         * 为一个特定的Call来创建一个EventListener.
         * 这个方法会在call方法被创建之后调用。See [OkHttpClient.newCall].
         *
         * ！！不要在这个方法中对call做任何变更操作。
         */
